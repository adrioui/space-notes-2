...
import MessageList from './message-list-client'
import MessageInput from './message-input-client'
import MembersDialog from '../space/members-dialog-client'
...
export default function ChatSectionClient({ spaceId, space }: ChatSectionClientProps) {
